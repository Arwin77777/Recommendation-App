...
import { addProduct, deleteRecommendation, getRecommendations, updateRecommendations } from './getItems.js';
...
app.get('/recommendation',async (req,res)=>{
  ...
  app.delete('/recommendation',async(req,res)=>{
    const {recommendationId} = req.query;
    console.log("Into delete endpoint",recommendationId);
    try{
      const del = await deleteRecommendation(recommendationId);
